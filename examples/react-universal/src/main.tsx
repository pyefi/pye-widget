    ...
    >
      ...
      >
        ...
        <div className="fade-up fade-up-2" style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            Unlock your staking
            <br />
            yield <span style={{ color: t.accent }}>— today.</span>
          </h1>
          <p
            style={{
              fontSize: 17,
        ...
        <div className="fade-up fade-up-4" style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <Feature t={t}
              ...
              desc="We detect all your active stake accounts across every validator automatically."
            />
            <Feature t={t}
              step={2}
            ...
            <Feature t={t}
              ...
              desc="At the end of the period, your full principal is returned to your wallet. Nothing leaves your validator."
            />
          </div>
        </div>
        ...
        >
          ...
          <span style={{ fontSize: 12, color: t.muted }}>
            Works with any Solana validator
          </span>
        </div>
      </div>
      ...
      {open && (
        ...
        >
          ...
          <PyeWidget
            rpcUrl="https://mainnet.helius-rpc.com/?api-key=1f92aa6d-a67f-4fca-8a5a-42b4347237a2"
